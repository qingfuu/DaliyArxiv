...
### [[20_Research/Papers/具身智能/From_Grasping_to_Speaking_Generative_AI-Based_Environment-Grounded_VR_Communication_Training_for_Autistic_Individuals|From Grasping to Speaking: Generative AI-Based Environment-Grounded VR Communication Training for Autistic Individuals]]

![[assets/2607.21769_first_page.png|800]]

- **arXiv**: [2607.21769](https://arxiv.org/abs/2607.21769)
- **PDF**: https://arxiv.org/pdf/2607.21769
- **详细分析**: [[20_Research/Papers/具身智能/From_Grasping_to_Speaking_Generative_AI-Based_Environment-Grounded_VR_Communication_Training_for_Autistic_Individuals|From Grasping to Speaking: Generative AI-Based Environment-Grounded VR Communication Training for Autistic Individuals]]
- **作者**: Ziming Li, Roshan L. Peiris
- **cs 子类**: cs.HC
- **归属领域**: 具身智能
- **相关领域**: 具身智能, 大模型
- **相关性评分**: 1.2（加权：具身智能 0.9，大模型 0.3）
- **关联关键词**: LLM, Agent, EmbodiedAI

#### 研究背景与动机

《From Grasping to Speaking: Generative AI-Based Environment-Grounded VR Communication Training for Autistic Individuals》归入 具身智能、大模型 方向。该论文围绕 Human-Computer Interaction 中的具体任务展开，重点关注方法在真实场景、复杂环境或高可靠性要求下的表现。从摘要和可见正文判断，研究动机主要来自：该工作聚焦 Human-Computer Interaction 方向中的具体问题。当前为无 LLM 兜底摘要，未直接粘贴英文证据句。

#### 方法概述和架构

方法上，论文主要涉及：引入智能体式建模或搜索。分析时应重点检查方法名称、输入输出、核心模块、训练或推理流程，以及这些模块如何服务于 具身智能、大模型 场景。由于当前未启用 LLM 深读，这里只给出结构化中文兜底，不保留英文原句。
...
### [[20_Research/Papers/大模型/Unfit_for_stranding_assessment_a_panel-scale_multimodal-LLM_audit_of_building-decarbonisation_disclosure_(BeDA)|Unfit for stranding assessment: a panel-scale multimodal-LLM audit of building-decarbonisation disclosure (BeDA)]]

![[assets/2607.22006_figure.png|800]]

- **arXiv**: [2607.22006](https://arxiv.org/abs/2607.22006)
- **PDF**: https://arxiv.org/pdf/2607.22006
- **详细分析**: [[20_Research/Papers/大模型/Unfit_for_stranding_assessment_a_panel-scale_multimodal-LLM_audit_of_building-decarbonisation_disclosure_(BeDA)|Unfit for stranding assessment: a panel-scale multimodal-LLM audit of building-decarbonisation disclosure (BeDA)]]
...
《Unfit for stranding assessment: a panel-scale multimodal-LLM audit of building-decarbonisation disclosure (BeDA)》归入 大模型 方向。该论文围绕 Computers and Society 中的具体任务展开，重点关注方法在真实场景、复杂环境或高可靠性要求下的表现。从摘要和可见正文判断，研究动机主要来自：相关基准、数据或方法仍不充分；鲁棒性和泛化能力是核心问题。当前为无 LLM 兜底摘要，未直接粘贴英文证据句。
...
### [[20_Research/Papers/强化学习/Predictive_Lightweight_MARL_for_Resilient_Coverage_in_Sparse-Signaling_Aerial_Networks|Predictive Lightweight MARL for Resilient Coverage in Sparse-Signaling Aerial Networks]]

![[assets/2607.22109_figure.png|800]]

- **arXiv**: [2607.22109](https://arxiv.org/abs/2607.22109)
- **PDF**: https://arxiv.org/pdf/2607.22109
- **详细分析**: [[20_Research/Papers/强化学习/Predictive_Lightweight_MARL_for_Resilient_Coverage_in_Sparse-Signaling_Aerial_Networks|Predictive Lightweight MARL for Resilient Coverage in Sparse-Signaling Aerial Networks]]
- **作者**: Chuan-Chi Lai, Ang-Hsun Tsai
- **cs 子类**: cs.NI
- **归属领域**: 强化学习
- **相关领域**: 强化学习, 机器人, 大模型
- **相关性评分**: 0.5（加权：大模型 0.1，强化学习 0.2，机器人 0.2）
- **关联关键词**: Agent, RL

#### 研究背景与动机

《Predictive Lightweight MARL for Resilient Coverage in Sparse-Signaling Aerial Networks》归入 强化学习、机器人、大模型 方向。该论文围绕 Networking and Internet Architecture 中的具体任务展开，重点关注方法在真实场景、复杂环境或高可靠性要求下的表现。从摘要和可见正文判断，研究动机主要来自：任务本身具有较高难度；相关基准、数据或方法仍不充分；实时应用对效率提出要求。当前为无 LLM 兜底摘要，未直接粘贴英文证据句。
...
实验结果方面，可见文本显示：达到作者报告的目标性能；关注鲁棒性或泛化表现。 可见文本中出现的评测对象/数据集包括：MARL, PL-MARL。 如果需要进一步判断价值，应继续核对原文中的主实验表、消融实验和失败案例。
...
### [[20_Research/Papers/机器人/Trade-off_for_Secure_UAV-ISCC_Systems|Trade-off for Secure UAV-ISCC Systems]]

![[assets/2607.21939_first_page.png|800]]

- **arXiv**: [2607.21939](https://arxiv.org/abs/2607.21939)
- **PDF**: https://arxiv.org/pdf/2607.21939
- **详细分析**: [[20_Research/Papers/机器人/Trade-off_for_Secure_UAV-ISCC_Systems|Trade-off for Secure UAV-ISCC Systems]]
- **作者**: Hongjiang Lei, Jun He, Congke Jiang, Ki-Hong Park, Wenqian Shen, Liang Yang, Gaofeng Pan
- **cs 子类**: cs.IT
- **归属领域**: 机器人
- **相关领域**: 机器人
...
《Trade-off for Secure UAV-ISCC Systems》归入 机器人 方向。该论文围绕 Information Theory 中的具体任务展开，重点关注方法在真实场景、复杂环境或高可靠性要求下的表现。从摘要和可见正文判断，研究动机主要来自：该工作聚焦 Information Theory 方向中的具体问题。当前为无 LLM 兜底摘要，未直接粘贴英文证据句。

#### 方法概述和架构

方法上，论文主要涉及：使用优化建模或搜索过程。分析时应重点检查方法名称、输入输出、核心模块、训练或推理流程，以及这些模块如何服务于 机器人 场景。由于当前未启用 LLM 深读，这里只给出结构化中文兜底，不保留英文原句。
