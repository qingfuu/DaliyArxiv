...
### [[20_Research/Papers/具身智能/Handroid_Bridging_Dexterous_Hand_and_Humanoid|Handroid: Bridging Dexterous Hand and Humanoid]]

![[assets/2607.16187_figure.png|800]]

- **arXiv**: [2607.16187](https://arxiv.org/abs/2607.16187)
- **PDF**: https://arxiv.org/pdf/2607.16187
- **详细分析**: [[20_Research/Papers/具身智能/Handroid_Bridging_Dexterous_Hand_and_Humanoid|Handroid: Bridging Dexterous Hand and Humanoid]]
- **作者**: Ruogu Li, Chenyang Ma, Sikai Li, Zhenyu Wei, Yunchao Yao, Haochen Shi, C. Karen Liu, Shuran Song, Mingyu Ding
- **cs 子类**: cs.RO
- **归属领域**: 具身智能
- **相关领域**: 具身智能, 机器人
- **相关性评分**: 4.8（加权：具身智能 3.3，机器人 1.5）
- **关联关键词**: Robotics, EmbodiedAI

#### 研究背景与动机

《Handroid: Bridging Dexterous Hand and Humanoid》归入 具身智能、机器人 方向。该论文围绕 Robotics 中的具体任务展开，重点关注方法在真实场景、复杂环境或高可靠性要求下的表现。从摘要和可见正文判断，研究动机主要来自：现有方法仍面临挑战；现有方法存在能力或适用范围限制；系统成本或推理开销是关键约束。当前为无 LLM 兜底摘要，未直接粘贴英文证据句。
...
### [[20_Research/Papers/具身智能/SkillNav_Score-Level_Skill_Intervention_for_Zero-Shot_Object_Goal_Navigation|SkillNav: Score-Level Skill Intervention for Zero-Shot Object Goal Navigation]]

![[assets/2607.15758_figure.png|800]]

- **arXiv**: [2607.15758](https://arxiv.org/abs/2607.15758)
- **PDF**: https://arxiv.org/pdf/2607.15758
- **详细分析**: [[20_Research/Papers/具身智能/SkillNav_Score-Level_Skill_Intervention_for_Zero-Shot_Object_Goal_Navigation|SkillNav: Score-Level Skill Intervention for Zero-Shot Object Goal Navigation]]
...
《SkillNav: Score-Level Skill Intervention for Zero-Shot Object Goal Navigation》归入 具身智能、大模型、机器人 方向。该论文围绕 Robotics 中的具体任务展开，重点关注方法在真实场景、复杂环境或高可靠性要求下的表现。从摘要和可见正文判断，研究动机主要来自：相关基准、数据或方法仍不充分；系统成本或推理开销是关键约束。当前为无 LLM 兜底摘要，未直接粘贴英文证据句。

#### 方法概述和架构

方法上，论文主要涉及：构建或使用基准评测体系；提出新的模型、框架或算法；设计端到端框架。分析时应重点检查方法名称、输入输出、核心模块、训练或推理流程，以及这些模块如何服务于 具身智能、大模型、机器人 场景。由于当前未启用 LLM 深读，这里只给出结构化中文兜底，不保留英文原句。
...
### [[20_Research/Papers/机器人/Towards_Artificial_Nerves_Biomimetic_Optical-Fiber_Tactile_Sensing_for_Robots|Towards Artificial Nerves: Biomimetic Optical-Fiber Tactile Sensing for Robots]]

![[assets/2607.15746_figure.png|800]]

- **arXiv**: [2607.15746](https://arxiv.org/abs/2607.15746)
- **PDF**: https://arxiv.org/pdf/2607.15746
- **详细分析**: [[20_Research/Papers/机器人/Towards_Artificial_Nerves_Biomimetic_Optical-Fiber_Tactile_Sensing_for_Robots|Towards Artificial Nerves: Biomimetic Optical-Fiber Tactile Sensing for Robots]]
...
《Towards Artificial Nerves: Biomimetic Optical-Fiber Tactile Sensing for Robots》归入 具身智能、机器人 方向。该论文围绕 Robotics 中的具体任务展开，重点关注方法在真实场景、复杂环境或高可靠性要求下的表现。从摘要和可见正文判断，研究动机主要来自：相关基准、数据或方法仍不充分；系统成本或推理开销是关键约束。当前为无 LLM 兜底摘要，未直接粘贴英文证据句。
...
### [[20_Research/Papers/具身智能/AC-VLA_Robust_Out-of-Distribution_Action_Execution_via_Compositional_Learning|AC-VLA: Robust Out-of-Distribution Action Execution via Compositional Learning]]

![[assets/2607.15714_figure.png|800]]

- **arXiv**: [2607.15714](https://arxiv.org/abs/2607.15714)
- **PDF**: https://arxiv.org/pdf/2607.15714
- **详细分析**: [[20_Research/Papers/具身智能/AC-VLA_Robust_Out-of-Distribution_Action_Execution_via_Compositional_Learning|AC-VLA: Robust Out-of-Distribution Action Execution via Compositional Learning]]
...
《AC-VLA: Robust Out-of-Distribution Action Execution via Compositional Learning》归入 具身智能、机器人、大模型 方向。该论文围绕 Robotics 中的具体任务展开，重点关注方法在真实场景、复杂环境或高可靠性要求下的表现。从摘要和可见正文判断，研究动机主要来自：现有方法仍面临挑战；实时应用对效率提出要求；鲁棒性和泛化能力是核心问题。当前为无 LLM 兜底摘要，未直接粘贴英文证据句。
...
实验结果方面，可见文本显示：在目标指标上带来改进；达到作者报告的目标性能；实验或分析展示了方法有效性。 可见文本中出现的评测对象/数据集包括：AC-VLA, Real-World。 如果需要进一步判断价值，应继续核对原文中的主实验表、消融实验和失败案例。
...
### [[20_Research/Papers/具身智能/RAVEN_Reinforcement-Adaptive_Visibility-Graph_Planning_for_Robust_Humanoid_Navigation_with_Collision-Free_MPC|RAVEN: Reinforcement-Adaptive Visibility-Graph Planning for Robust Humanoid Navigation with Collision-Free MPC]]

![[assets/2607.15701_figure.png|800]]

- **arXiv**: [2607.15701](https://arxiv.org/abs/2607.15701)
- **PDF**: https://arxiv.org/pdf/2607.15701
- **详细分析**: [[20_Research/Papers/具身智能/RAVEN_Reinforcement-Adaptive_Visibility-Graph_Planning_for_Robust_Humanoid_Navigation_with_Collision-Free_MPC|RAVEN: Reinforcement-Adaptive Visibility-Graph Planning for Robust Humanoid Navigation with Collision-Free MPC]]
...
《RAVEN: Reinforcement-Adaptive Visibility-Graph Planning for Robust Humanoid Navigation with Collision-Free MPC》归入 具身智能、机器人、强化学习 方向。该论文围绕 Robotics 中的具体任务展开，重点关注方法在真实场景、复杂环境或高可靠性要求下的表现。从摘要和可见正文判断，研究动机主要来自：现有方法仍面临挑战；任务本身具有较高难度；相关基准、数据或方法仍不充分。当前为无 LLM 兜底摘要，未直接粘贴英文证据句。
...
### [[20_Research/Papers/具身智能/Continuously_Stable_Structure_through_Plastic_Deformation|Continuously Stable Structure through Plastic Deformation]]

![[assets/2607.15659_first_page.png|800]]

- **arXiv**: [2607.15659](https://arxiv.org/abs/2607.15659)
- **PDF**: https://arxiv.org/pdf/2607.15659
- **详细分析**: [[20_Research/Papers/具身智能/Continuously_Stable_Structure_through_Plastic_Deformation|Continuously Stable Structure through Plastic Deformation]]
...
《Continuously Stable Structure through Plastic Deformation》归入 具身智能、机器人 方向。该论文围绕 Robotics 中的具体任务展开，重点关注方法在真实场景、复杂环境或高可靠性要求下的表现。从摘要和可见正文判断，研究动机主要来自：现有方法仍面临挑战；系统成本或推理开销是关键约束。当前为无 LLM 兜底摘要，未直接粘贴英文证据句。
...
### [[20_Research/Papers/具身智能/Difference-Based_Relational_Learning_for_Zero-Shot_Object-Goal_Visual_Navigation_With_Direct_Sim-to-Real_Transfer|Difference-Based Relational Learning for Zero-Shot Object-Goal Visual Navigation With Direct Sim-to-Real Transfer]]

![[assets/2607.15642_figure.png|800]]

- **arXiv**: [2607.15642](https://arxiv.org/abs/2607.15642)
- **PDF**: https://arxiv.org/pdf/2607.15642
- **详细分析**: [[20_Research/Papers/具身智能/Difference-Based_Relational_Learning_for_Zero-Shot_Object-Goal_Visual_Navigation_With_Direct_Sim-to-Real_Transfer|Difference-Based Relational Learning for Zero-Shot Object-Goal Visual Navigation With Direct Sim-to-Real Transfer]]
- **作者**: Guolei Qi, Feitian Zhang
- **cs 子类**: cs.RO
- **归属领域**: 具身智能
- **相关领域**: 具身智能, 机器人, 强化学习
- **相关性评分**: 2.4（加权：具身智能 1.5，强化学习 0.4，机器人 0.5）
- **关联关键词**: Robotics, EmbodiedAI, RL

#### 研究背景与动机

《Difference-Based Relational Learning for Zero-Shot Object-Goal Visual Navigation With Direct Sim-to-Real Transfer》归入 具身智能、机器人、强化学习 方向。该论文围绕 Robotics 中的具体任务展开，重点关注方法在真实场景、复杂环境或高可靠性要求下的表现。从摘要和可见正文判断，研究动机主要来自：现有方法仍面临挑战；相关基准、数据或方法仍不充分；系统成本或推理开销是关键约束。当前为无 LLM 兜底摘要，未直接粘贴英文证据句。
...
实验结果方面，可见文本显示：在目标指标上带来改进；达到作者报告的目标性能；实验或分析展示了方法有效性。 可见文本中出现的评测对象/数据集包括：DRL, Real-World, TDANet。 如果需要进一步判断价值，应继续核对原文中的主实验表、消融实验和失败案例。
...
### [[20_Research/Papers/具身智能/Risk-Aware_Preference_Learning_for_Stochastic_Outcomes|Risk-Aware Preference Learning for Stochastic Outcomes]]

![[assets/2607.15483_figure.png|800]]

- **arXiv**: [2607.15483](https://arxiv.org/abs/2607.15483)
- **PDF**: https://arxiv.org/pdf/2607.15483
- **详细分析**: [[20_Research/Papers/具身智能/Risk-Aware_Preference_Learning_for_Stochastic_Outcomes|Risk-Aware Preference Learning for Stochastic Outcomes]]
...
《Risk-Aware Preference Learning for Stochastic Outcomes》归入 具身智能、机器人 方向。该论文围绕 Robotics 中的具体任务展开，重点关注方法在真实场景、复杂环境或高可靠性要求下的表现。从摘要和可见正文判断，研究动机主要来自：现有方法仍面临挑战；任务本身具有较高难度。当前为无 LLM 兜底摘要，未直接粘贴英文证据句。
...
### [[20_Research/Papers/具身智能/VTAP_Gripper_Synergizing_Fingertip_Sensing_and_a_Visuo-Tactile_Active_Palm_for_Dexterous_In-Hand_Manipulation|VTAP Gripper: Synergizing Fingertip Sensing and a Visuo-Tactile Active Palm for Dexterous In-Hand Manipulation]]

![[assets/2607.15448_figure.png|800]]

- **arXiv**: [2607.15448](https://arxiv.org/abs/2607.15448)
- **PDF**: https://arxiv.org/pdf/2607.15448
- **详细分析**: [[20_Research/Papers/具身智能/VTAP_Gripper_Synergizing_Fingertip_Sensing_and_a_Visuo-Tactile_Active_Palm_for_Dexterous_In-Hand_Manipulation|VTAP Gripper: Synergizing Fingertip Sensing and a Visuo-Tactile Active Palm for Dexterous In-Hand Manipulation]]
...
《VTAP Gripper: Synergizing Fingertip Sensing and a Visuo-Tactile Active Palm for Dexterous In-Hand Manipulation》归入 具身智能、机器人 方向。该论文围绕 Robotics 中的具体任务展开，重点关注方法在真实场景、复杂环境或高可靠性要求下的表现。从摘要和可见正文判断，研究动机主要来自：现有方法仍面临挑战；任务本身具有较高难度；现有方法存在能力或适用范围限制。当前为无 LLM 兜底摘要，未直接粘贴英文证据句。
...
### [[20_Research/Papers/其他/A_Human-Centric_Evaluation_of_a_Retrieval-Augmented_Generation_System_for_Explaining_Quebec_Insurance_Contracts|A Human-Centric Evaluation of a Retrieval-Augmented Generation System for Explaining Quebec Insurance Contracts]]

![[assets/2607.15963_figure.png|800]]

- **arXiv**: [2607.15963](https://arxiv.org/abs/2607.15963)
- **PDF**: https://arxiv.org/pdf/2607.15963
- **详细分析**: [[20_Research/Papers/其他/A_Human-Centric_Evaluation_of_a_Retrieval-Augmented_Generation_System_for_Explaining_Quebec_Insurance_Contracts|A Human-Centric Evaluation of a Retrieval-Augmented Generation System for Explaining Quebec Insurance Contracts]]
...
《A Human-Centric Evaluation of a Retrieval-Augmented Generation System for Explaining Quebec Insurance Contracts》归入 大模型 方向。该论文围绕 Human-Computer Interaction 中的具体任务展开，重点关注方法在真实场景、复杂环境或高可靠性要求下的表现。从摘要和可见正文判断，研究动机主要来自：现有方法仍面临挑战；现有方法存在能力或适用范围限制；鲁棒性和泛化能力是核心问题。当前为无 LLM 兜底摘要，未直接粘贴英文证据句。
...
实验结果方面，可见文本显示：在目标指标上带来改进；实验或分析展示了方法有效性；结果验证了方案可行性。 可见文本中出现的评测对象/数据集包括：LegalBench。 如果需要进一步判断价值，应继续核对原文中的主实验表、消融实验和失败案例。
...
### [[20_Research/Papers/其他/Making_Agent-Mediated_Contributions_Governable_A_Project-Level_Governance_Manifest_for_Open-Source_AI_Collaboration|Making Agent-Mediated Contributions Governable: A Project-Level Governance Manifest for Open-Source AI Collaboration]]

![[assets/2607.15769_figure.png|800]]

- **arXiv**: [2607.15769](https://arxiv.org/abs/2607.15769)
- **PDF**: https://arxiv.org/pdf/2607.15769
- **详细分析**: [[20_Research/Papers/其他/Making_Agent-Mediated_Contributions_Governable_A_Project-Level_Governance_Manifest_for_Open-Source_AI_Collaboration|Making Agent-Mediated Contributions Governable: A Project-Level Governance Manifest for Open-Source AI Collaboration]]
- **作者**: Jinjin Gao, Luyang Li, Shufen Guo, Ligang He, Xiaoning Sun
- **cs 子类**: cs.CY, cs.SE
- **归属领域**: 大模型
- **相关领域**: 大模型
- **相关性评分**: 0.5（加权：大模型 0.5）
...
《Making Agent-Mediated Contributions Governable: A Project-Level Governance Manifest for Open-Source AI Collaboration》归入 大模型 方向。该论文围绕 Computers and Society 中的具体任务展开，重点关注方法在真实场景、复杂环境或高可靠性要求下的表现。从摘要和可见正文判断，研究动机主要来自：现有方法仍面临挑战；现有方法存在能力或适用范围限制；相关基准、数据或方法仍不充分。当前为无 LLM 兜底摘要，未直接粘贴英文证据句。
...
### [[20_Research/Papers/大模型/EduGuard_A_Safe_RAG-Based_LLM_Tutor_for_Programming_Education|EduGuard: A Safe RAG-Based LLM Tutor for Programming Education]]

![[assets/2607.15738_figure.png|800]]

- **arXiv**: [2607.15738](https://arxiv.org/abs/2607.15738)
- **PDF**: https://arxiv.org/pdf/2607.15738
- **详细分析**: [[20_Research/Papers/大模型/EduGuard_A_Safe_RAG-Based_LLM_Tutor_for_Programming_Education|EduGuard: A Safe RAG-Based LLM Tutor for Programming Education]]
...
《EduGuard: A Safe RAG-Based LLM Tutor for Programming Education》归入 大模型 方向。该论文围绕 Computers and Society 中的具体任务展开，重点关注方法在真实场景、复杂环境或高可靠性要求下的表现。从摘要和可见正文判断，研究动机主要来自：现有方法仍面临挑战；任务本身具有较高难度；现有方法存在能力或适用范围限制。当前为无 LLM 兜底摘要，未直接粘贴英文证据句。
...
### [[20_Research/Papers/强化学习/Data_and_Learning_Where_it_Matters_for_Contact-Rich_Manipulation|Data and Learning Where it Matters for Contact-Rich Manipulation]]

![[assets/2607.15982_figure.png|800]]

- **arXiv**: [2607.15982](https://arxiv.org/abs/2607.15982)
- **PDF**: https://arxiv.org/pdf/2607.15982
- **详细分析**: [[20_Research/Papers/强化学习/Data_and_Learning_Where_it_Matters_for_Contact-Rich_Manipulation|Data and Learning Where it Matters for Contact-Rich Manipulation]]
...
- **归属领域**: 强化学习
- **相关领域**: 强化学习
- **相关性评分**: 0.4（加权：强化学习 0.4）
- **关联关键词**: Agent, Robotics, RL

#### 研究背景与动机

《Data and Learning Where it Matters for Contact-Rich Manipulation》归入 强化学习 方向。该论文围绕 Robotics 中的具体任务展开，重点关注方法在真实场景、复杂环境或高可靠性要求下的表现。从摘要和可见正文判断，研究动机主要来自：任务本身具有较高难度；现有方法存在能力或适用范围限制；相关基准、数据或方法仍不充分。当前为无 LLM 兜底摘要，未直接粘贴英文证据句。
...
实验结果方面，可见文本显示：相对已有方法取得更好表现；在目标指标上带来改进；达到作者报告的目标性能。 可见文本中出现的评测对象/数据集包括：DRL, HIL-SERL。 如果需要进一步判断价值，应继续核对原文中的主实验表、消融实验和失败案例。
...
![[assets/2607.16146_figure.png|800]]
...
《VTLoc: Learning-based Tactile Contact Localization in Visual Point Clouds》归入 机器人、具身智能 方向。该论文围绕 Computer Vision and Pattern Recognition 中的具体任务展开，重点关注方法在真实场景、复杂环境或高可靠性要求下的表现。从摘要和可见正文判断，研究动机主要来自：现有方法仍面临挑战；鲁棒性和泛化能力是核心问题。当前为无 LLM 兜底摘要，未直接粘贴英文证据句。
...
实验结果方面，可见文本显示：在目标指标上带来改进；实验或分析展示了方法有效性；结果验证了方案可行性。 可见文本中出现的评测对象/数据集包括：PointNet, ResNet。 如果需要进一步判断价值，应继续核对原文中的主实验表、消融实验和失败案例。
...
### [[20_Research/Papers/大模型/BayesContact_Uncertain_Pose_Estimation_via_Visuo-Tactile_Proposals_and_Simulation-based_Inference|BayesContact: Uncertain Pose Estimation via Visuo-Tactile Proposals and Simulation-based Inference]]

![[assets/2607.16123_figure.png|800]]

- **arXiv**: [2607.16123](https://arxiv.org/abs/2607.16123)
- **PDF**: https://arxiv.org/pdf/2607.16123
- **详细分析**: [[20_Research/Papers/大模型/BayesContact_Uncertain_Pose_Estimation_via_Visuo-Tactile_Proposals_and_Simulation-based_Inference|BayesContact: Uncertain Pose Estimation via Visuo-Tactile Proposals and Simulation-based Inference]]
...
《BayesContact: Uncertain Pose Estimation via Visuo-Tactile Proposals and Simulation-based Inference》归入 机器人、具身智能、大模型 方向。该论文围绕 Robotics 中的具体任务展开，重点关注方法在真实场景、复杂环境或高可靠性要求下的表现。从摘要和可见正文判断，研究动机主要来自：现有方法仍面临挑战；任务本身具有较高难度；现有方法存在能力或适用范围限制。当前为无 LLM 兜底摘要，未直接粘贴英文证据句。
...
### [[20_Research/Papers/机器人/Let_the_Body_Follow_Coupled_Egocentric_Control_for_Whole-Body_Robot_Teleoperation|Let the Body Follow: Coupled Egocentric Control for Whole-Body Robot Teleoperation]]

![[assets/2607.16095_figure.png|800]]

- **arXiv**: [2607.16095](https://arxiv.org/abs/2607.16095)
- **PDF**: https://arxiv.org/pdf/2607.16095
- **详细分析**: [[20_Research/Papers/机器人/Let_the_Body_Follow_Coupled_Egocentric_Control_for_Whole-Body_Robot_Teleoperation|Let the Body Follow: Coupled Egocentric Control for Whole-Body Robot Teleoperation]]
...
《Let the Body Follow: Coupled Egocentric Control for Whole-Body Robot Teleoperation》归入 机器人、具身智能 方向。该论文围绕 Robotics 中的具体任务展开，重点关注方法在真实场景、复杂环境或高可靠性要求下的表现。从摘要和可见正文判断，研究动机主要来自：任务本身具有较高难度；实时应用对效率提出要求。当前为无 LLM 兜底摘要，未直接粘贴英文证据句。
...
### [[20_Research/Papers/机器人/Deployment-Ready_UWB_Localization_for_Industrial_Ground_Robots_with_Automatic_Anchor_Calibration_and_Terrain-Aware_Fusion|Deployment-Ready UWB Localization for Industrial Ground Robots with Automatic Anchor Calibration and Terrain-Aware Fusion]]

![[assets/2607.15807_figure.png|800]]

- **arXiv**: [2607.15807](https://arxiv.org/abs/2607.15807)
- **PDF**: https://arxiv.org/pdf/2607.15807
- **详细分析**: [[20_Research/Papers/机器人/Deployment-Ready_UWB_Localization_for_Industrial_Ground_Robots_with_Automatic_Anchor_Calibration_and_Terrain-Aware_Fusion|Deployment-Ready UWB Localization for Industrial Ground Robots with Automatic Anchor Calibration and Terrain-Aware Fusion]]
...
《Deployment-Ready UWB Localization for Industrial Ground Robots with Automatic Anchor Calibration and Terrain-Aware Fusion》归入 机器人、具身智能 方向。该论文围绕 Robotics 中的具体任务展开，重点关注方法在真实场景、复杂环境或高可靠性要求下的表现。从摘要和可见正文判断，研究动机主要来自：现有方法仍面临挑战；现有方法存在能力或适用范围限制；系统成本或推理开销是关键约束。当前为无 LLM 兜底摘要，未直接粘贴英文证据句。
...
### [[20_Research/Papers/机器人/A_Task-Space_Receding_Horizon_Controller_for_Fast_Collision_Avoidance|A Task-Space Receding Horizon Controller for Fast Collision Avoidance]]

![[assets/2607.15733_figure.png|800]]

- **arXiv**: [2607.15733](https://arxiv.org/abs/2607.15733)
- **PDF**: https://arxiv.org/pdf/2607.15733
- **详细分析**: [[20_Research/Papers/机器人/A_Task-Space_Receding_Horizon_Controller_for_Fast_Collision_Avoidance|A Task-Space Receding Horizon Controller for Fast Collision Avoidance]]
...
《A Task-Space Receding Horizon Controller for Fast Collision Avoidance》归入 机器人、具身智能 方向。该论文围绕 Robotics 中的具体任务展开，重点关注方法在真实场景、复杂环境或高可靠性要求下的表现。从摘要和可见正文判断，研究动机主要来自：现有方法存在能力或适用范围限制；系统成本或推理开销是关键约束；实时应用对效率提出要求。当前为无 LLM 兜底摘要，未直接粘贴英文证据句。
...
### [[20_Research/Papers/机器人/Implicit_Virtual_Leader_Decentralized_Vision-Only_Relative_Pose_Estimation_for_Multi-Robot_Formations|Implicit Virtual Leader: Decentralized Vision-Only Relative Pose Estimation for Multi-Robot Formations]]

![[assets/2607.15708_figure.png|800]]

- **arXiv**: [2607.15708](https://arxiv.org/abs/2607.15708)
- **PDF**: https://arxiv.org/pdf/2607.15708
- **详细分析**: [[20_Research/Papers/机器人/Implicit_Virtual_Leader_Decentralized_Vision-Only_Relative_Pose_Estimation_for_Multi-Robot_Formations|Implicit Virtual Leader: Decentralized Vision-Only Relative Pose Estimation for Multi-Robot Formations]]
...
《Implicit Virtual Leader: Decentralized Vision-Only Relative Pose Estimation for Multi-Robot Formations》归入 机器人、具身智能 方向。该论文围绕 Robotics 中的具体任务展开，重点关注方法在真实场景、复杂环境或高可靠性要求下的表现。从摘要和可见正文判断，研究动机主要来自：现有方法仍面临挑战；相关基准、数据或方法仍不充分；系统成本或推理开销是关键约束。当前为无 LLM 兜底摘要，未直接粘贴英文证据句。
...
### [[20_Research/Papers/具身智能/A_Generative_Partially_Specified_Finite_State_Machine_Approach_to_Complex_Behaviour_Planning|A Generative Partially Specified Finite State Machine Approach to Complex Behaviour Planning]]

![[assets/2607.15674_figure.png|800]]

- **arXiv**: [2607.15674](https://arxiv.org/abs/2607.15674)
- **PDF**: https://arxiv.org/pdf/2607.15674
- **详细分析**: [[20_Research/Papers/具身智能/A_Generative_Partially_Specified_Finite_State_Machine_Approach_to_Complex_Behaviour_Planning|A Generative Partially Specified Finite State Machine Approach to Complex Behaviour Planning]]
...
《A Generative Partially Specified Finite State Machine Approach to Complex Behaviour Planning》归入 机器人、具身智能 方向。该论文围绕 Robotics 中的具体任务展开，重点关注方法在真实场景、复杂环境或高可靠性要求下的表现。从摘要和可见正文判断，研究动机主要来自：现有方法仍面临挑战；现有方法存在能力或适用范围限制；相关基准、数据或方法仍不充分。当前为无 LLM 兜底摘要，未直接粘贴英文证据句。
...
### [[20_Research/Papers/机器人/Scalable_Open-Source_Visuotactile_Sensor_for_6-Axis_Contact_Wrench_Estimation_in_Tensegrity_Robots|Scalable Open-Source Visuotactile Sensor for 6-Axis Contact Wrench Estimation in Tensegrity Robots]]

![[assets/2607.15633_figure.png|800]]

- **arXiv**: [2607.15633](https://arxiv.org/abs/2607.15633)
- **PDF**: https://arxiv.org/pdf/2607.15633
- **详细分析**: [[20_Research/Papers/机器人/Scalable_Open-Source_Visuotactile_Sensor_for_6-Axis_Contact_Wrench_Estimation_in_Tensegrity_Robots|Scalable Open-Source Visuotactile Sensor for 6-Axis Contact Wrench Estimation in Tensegrity Robots]]
...
《Scalable Open-Source Visuotactile Sensor for 6-Axis Contact Wrench Estimation in Tensegrity Robots》归入 机器人、具身智能 方向。该论文围绕 Robotics 中的具体任务展开，重点关注方法在真实场景、复杂环境或高可靠性要求下的表现。从摘要和可见正文判断，研究动机主要来自：现有方法仍面临挑战；现有方法存在能力或适用范围限制；相关基准、数据或方法仍不充分。当前为无 LLM 兜底摘要，未直接粘贴英文证据句。

#### 方法概述和架构

方法上，论文主要涉及：引入数据集或数据收集流程；引入智能体式建模或搜索。分析时应重点检查方法名称、输入输出、核心模块、训练或推理流程，以及这些模块如何服务于 机器人、具身智能 场景。由于当前未启用 LLM 深读，这里只给出结构化中文兜底，不保留英文原句。
...
### [[20_Research/Papers/具身智能/PACE_Persona_Adaptation_through_Conversational_Elicitation_in_Human-Robot_Interaction|PACE: Persona Adaptation through Conversational Elicitation in Human-Robot Interaction]]

![[assets/2607.15579_figure.png|800]]

- **arXiv**: [2607.15579](https://arxiv.org/abs/2607.15579)
- **PDF**: https://arxiv.org/pdf/2607.15579
- **详细分析**: [[20_Research/Papers/具身智能/PACE_Persona_Adaptation_through_Conversational_Elicitation_in_Human-Robot_Interaction|PACE: Persona Adaptation through Conversational Elicitation in Human-Robot Interaction]]
...
《PACE: Persona Adaptation through Conversational Elicitation in Human-Robot Interaction》归入 机器人、具身智能、大模型 方向。该论文围绕 Human-Computer Interaction 中的具体任务展开，重点关注方法在真实场景、复杂环境或高可靠性要求下的表现。从摘要和可见正文判断，研究动机主要来自：现有方法存在能力或适用范围限制；相关基准、数据或方法仍不充分；实时应用对效率提出要求。当前为无 LLM 兜底摘要，未直接粘贴英文证据句。
...
### [[20_Research/Papers/机器人/Multi-Objective_Kinodynamic_Motion_Planning_with_Asymptotic_Pareto_Optimality|Multi-Objective Kinodynamic Motion Planning with Asymptotic Pareto Optimality]]

![[assets/2607.15508_figure.png|800]]

- **arXiv**: [2607.15508](https://arxiv.org/abs/2607.15508)
- **PDF**: https://arxiv.org/pdf/2607.15508
- **详细分析**: [[20_Research/Papers/机器人/Multi-Objective_Kinodynamic_Motion_Planning_with_Asymptotic_Pareto_Optimality|Multi-Objective Kinodynamic Motion Planning with Asymptotic Pareto Optimality]]
...
《Multi-Objective Kinodynamic Motion Planning with Asymptotic Pareto Optimality》归入 机器人、具身智能 方向。该论文围绕 Robotics 中的具体任务展开，重点关注方法在真实场景、复杂环境或高可靠性要求下的表现。从摘要和可见正文判断，研究动机主要来自：现有方法仍面临挑战；现有方法存在能力或适用范围限制；系统成本或推理开销是关键约束。当前为无 LLM 兜底摘要，未直接粘贴英文证据句。
...
### [[20_Research/Papers/机器人/Robust_Silicone_Pour_Casting_and_Sensor_Embedding_Procedures_for_Soft_Robotic_Actuators|Robust Silicone Pour Casting and Sensor Embedding Procedures for Soft Robotic Actuators]]

![[assets/2607.15422_first_page.png|800]]

- **arXiv**: [2607.15422](https://arxiv.org/abs/2607.15422)
- **PDF**: https://arxiv.org/pdf/2607.15422
- **详细分析**: [[20_Research/Papers/机器人/Robust_Silicone_Pour_Casting_and_Sensor_Embedding_Procedures_for_Soft_Robotic_Actuators|Robust Silicone Pour Casting and Sensor Embedding Procedures for Soft Robotic Actuators]]
...
《Robust Silicone Pour Casting and Sensor Embedding Procedures for Soft Robotic Actuators》归入 机器人、具身智能 方向。该论文围绕 Robotics 中的具体任务展开，重点关注方法在真实场景、复杂环境或高可靠性要求下的表现。从摘要和可见正文判断，研究动机主要来自：现有方法仍面临挑战；鲁棒性和泛化能力是核心问题。当前为无 LLM 兜底摘要，未直接粘贴英文证据句。
...
### [[20_Research/Papers/具身智能/NeuroCommitSSM_Decision-Centric_Shared_Autonomy_for_Safe_Assistive_Manipulation_via_EEG-EMG-ET_Commit_Readiness|NeuroCommitSSM: Decision-Centric Shared Autonomy for Safe Assistive Manipulation via EEG-EMG-ET Commit Readiness]]

![[assets/2607.15395_figure.png|800]]

- **arXiv**: [2607.15395](https://arxiv.org/abs/2607.15395)
- **PDF**: https://arxiv.org/pdf/2607.15395
- **详细分析**: [[20_Research/Papers/具身智能/NeuroCommitSSM_Decision-Centric_Shared_Autonomy_for_Safe_Assistive_Manipulation_via_EEG-EMG-ET_Commit_Readiness|NeuroCommitSSM: Decision-Centric Shared Autonomy for Safe Assistive Manipulation via EEG-EMG-ET Commit Readiness]]
...
《NeuroCommitSSM: Decision-Centric Shared Autonomy for Safe Assistive Manipulation via EEG-EMG-ET Commit Readiness》归入 机器人、具身智能 方向。该论文围绕 Robotics 中的具体任务展开，重点关注方法在真实场景、复杂环境或高可靠性要求下的表现。从摘要和可见正文判断，研究动机主要来自：现有方法仍面临挑战；现有方法存在能力或适用范围限制；实时应用对效率提出要求。当前为无 LLM 兜底摘要，未直接粘贴英文证据句。
